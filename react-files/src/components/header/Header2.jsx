              ...
              <ul className="submenu">
                ...
                <li>
                  <Link legacyBehavior href="/index2-video">
                    <a
                      className={
                        currentRoute === "/index2-video" ? "active" : ""
                      }
                    >
                      Agency Home Video
                    </a>
                ...
                <li>
                  <Link legacyBehavior href="/index2-pagination">
                    <a
                      className={
                        currentRoute === "/index2-pagination" ? "active" : ""
                      }
                    >
                      Agency Home Pagination
                    </a>
                  </Link>
                </li>
                <li>
                  <Link legacyBehavior href="/index2-center-slider">
                    <a
                      className={
                        currentRoute === "/index2-center-slider" ? "active" : ""
                      }
                    >
                      Agency Home Center Slider
                    </a>
                  </Link>
                </li>
              </ul>
